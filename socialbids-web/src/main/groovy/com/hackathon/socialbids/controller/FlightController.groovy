...
class FlightController {
    ...
    ResponseEntity verifyChallenge() {
        ...
        def messages = [new BidMessage(id: "1769834176420354", type: 'quickReply', replyOptions: ['Yes', 'No'], message: 'Hi Nidhin dev,  For the flight which you have booked on 26th November biding for Paid upgrade is open. Do you want to participate?'),
                        new BidMessage(id: "1563047500438143", type: 'quickReply', replyOptions: ['Yes', 'No'], message: 'Hi Vinod,  For the flight which you have booked on 26th November biding Paid upgrade is open. Do you want to participate?'),
                        new BidMessage(id: "1486773568044876", type: 'quickReply', replyOptions: ['Yes', 'No'], message: 'Hi Divya,  For the flight which you have booked on 26th November biding Paid upgrade is open. Do you want to participate?')]
        messages.forEach() {
